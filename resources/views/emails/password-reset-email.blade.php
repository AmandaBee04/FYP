        ...
        <tr>
            <td>
                <table align="center" width="60%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td>
                            ...
                            <p style="text-align: center;">
                                <a href="{{ $resetLink }}" class="Reset-btn" style="color: white; text-decoration: none;">Reset Password</a>
                            </p>
                    ...
                    <tr>
                        <td>
                            <p>If you're having trouble clicking the "Reset Password" button, copy and paste the URL below into your browser: <a href="{{ $resetLink }}">{{ $resetLink }}</a></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="copyright">
