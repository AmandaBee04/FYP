  ...
  useEffect(() => {
    const fetchQuestionsAndAnswers = async () => {
      try {
        ...
        const answersRes = await axios.get(`http://127.0.0.1:8000/api/student/${studentId}/question_set/${id}/stud_ans/getStudAns`);
...
export default StudentMCQQuizReview;
